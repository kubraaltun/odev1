...
<fieldset class="radiogroup">
<legend>Soru 7:<strong> '' iyi - genç - özgürlük - aşağı '' </strong>Yukarıdaki sözcüklerin hangisinin <strong>karşıt anlamlısı</strong> aşağıdaki cümlelerde verilmemiştir ?  </legend>
<ul class="radio" style="list-style:none">
...
<fieldset class="radiogroup">
<legend>Soru 9: Aşağıdaki cümlelerin hangisinde <strong>”amaç” belirtilmemiştir. </strong></legend>
<ul class="radio" style="list-style:none">
...
<fieldset class="radiogroup">
<legend>Soru 10: Şair, şiirinde herkes anlasın diye sade bir dil kullanmış. <strong>cümlesinin anlamca türü aşağıdakilerden hangisidir ?</strong></legend>
<ul class="radio" style="list-style:none">
